...
print("Running Tests...\n")
runner.run(unittest.TestSuite((unittest.makeSuite(ConvertDateTests)))) # DONE
runner.run(unittest.TestSuite((unittest.makeSuite(ConvertTempTests)))) # DONE
runner.run(unittest.TestSuite((unittest.makeSuite(CalculateMeanTests)))) # DONE
